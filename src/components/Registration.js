            ...
            <Container fluid style={{ width: "600px", margin: "70px auto" }}>
                ...
                <Form>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        ...
                        <Form.Control type="text" placeholder="Enter Password" ref={passInput} id="pass" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="formBasicEmail">

                        <Form.Control type="text" placeholder="Confirm Password" ref={cPassInput} id="cPass" />
                    </Form.Group>
